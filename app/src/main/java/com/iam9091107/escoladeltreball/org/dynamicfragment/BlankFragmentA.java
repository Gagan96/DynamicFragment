 ...
 * {@link OnFragmentAInteractionListener} interface
...
public class BlankFragmentA extends Fragment {
    ...
    public void onButtonPressed(String msg) {
        if (mListener != null) {
            mListener.onFragmentAInteraction(msg);
        }
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onButtonPressed("Hola desde fragment A");
            }
        };
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentAInteractionListener) {
            ...
            throw new RuntimeException(context.toString()
                    + " must implement OnFragmentAInteractionListener");
        }
    }
    ...
    public interface OnFragmentAInteractionListener {
        ...
        void onFragmentAInteraction(String msg);
    }
}
