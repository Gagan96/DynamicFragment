 ...
 * {@link OnFragmentBInteractionListener} interface
...
public class BlankFragmentB extends Fragment {
    ...
    public void onButtonPressed(String msg) {
        if (mListener != null) {
            mListener.onFragmentBInteraction(msg);
        }
    }
    ...
    private void sendToast(){
        onButtonPressed("Hola desde fragment B");
    }
    ...
    public interface OnFragmentBInteractionListener {
        ...
        void onFragmentBInteraction(String msg);
    }
}
